...
const SECTORS = [
  'Informatique & Télécoms', 'BTP & Travaux publics', 'Santé & Médical',
  'Éducation & Formation', 'Énergie & Environnement', 'Transport & Logistique',
            ...
            <div style={{ padding: '8px 0' }}>
              {keywords.map((r) => (
                <div key={r.id} style={{ display: 'flex', alignItems: 'center', padding: '10px 20px', borderBottom: '1px solid var(--border)', gap: 12 }}>
                  ...
                  <select
                    value={r.frequency}
                    onChange={(e) => setRules((rs) => rs.map((x) => x.id === r.id ? { ...x, frequency: e.target.value as any } : x))}
